...
workbox.precaching.precacheAndRoute([
  {url: 'index.html', revision: '03.07.22.1'},
  {url: 'manifest.json', revision: '02.10.22.1'},
  {url: 'assets/js/app.js', revision: '03.07.22.2'},
  {url: 'assets/css/app.css', revision: '03.07.22.1'},
  ...
  {url: 'data/trail_map.mbtiles', revision: '03.07.22.2'},
  {url: 'data/points.csv', revision: '02.17.22.1'},
  {url: 'data/interactive_points.geojson', revision: '03.07.22.1'}
], {
