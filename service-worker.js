...
workbox.precaching.precacheAndRoute([
  {url: 'index.html', revision: '02.22.22.1'},
  {url: 'manifest.json', revision: '02.10.22.1'},
  {url: 'assets/js/app.js', revision: '02.22.22.1'},
  {url: 'assets/css/app.css', revision: '02.17.22.1'},
  ...
  {url: 'assets/img/icons/Beach.png', revision: '02.16.22'},
  {url: 'assets/img/icons/Bird.png', revision: '02.16.22'},
  {url: 'assets/img/icons/Building.png', revision: '02.16.22'},
  ...
  {url: 'assets/img/icons/Research Site.png', revision: '02.16.22'},
  {url: 'assets/img/icons/Ruins.png', revision: '02.16.22'},
  {url: 'assets/img/icons/Trail.png', revision: '02.16.22'},
  {url: 'assets/img/icons/Waterfall.png', revision: '02.16.22'},
  ...
  {url: 'assets/vendor/bootstrap-5.1.3/css/bootstrap.min.css', revision: '02.16.22'},
  {url: 'assets/vendor/jquery-3.6.0.min.js', revision: '2.16.22.1'},
  {url: 'assets/vendor/bootstrap-5.1.3/js/bootstrap.bundle.min.js', revision: '02.16.22'},
  ...
  {url: 'data/trail_map.mbtiles', revision: '02.17.22.1'},
  {url: 'data/points.csv', revision: '02.17.22.1'},
  {url: 'data/interactive_points.geojson', revision: '02.17.22.1'}
], {
